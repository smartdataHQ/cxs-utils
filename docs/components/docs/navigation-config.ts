...
export const navigationConfig: NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Commented out until corresponding .mdoc files are created
  ...
  // Commented out entire sections until corresponding .mdoc files are created
  // {
  //   title: 'Event Bible',
  //   items: [
  ...
  //     { title: 'Example Events', href: '/docs/semantic-events/bible/example-events', icon: Eye, children: [
  //       { title: 'Hotel List Viewed Example', href: '/docs/semantic-events/bible/example-events/hotel-list-viewed-example', icon: Eye },
  //       { title: 'Hotel Viewed Example', href: '/docs/semantic-events/bible/example-events/hotel-viewed-example', icon: Eye },
  //       { title: 'Room List Viewed Example', href: '/docs/semantic-events/bible/example-events/room-list-viewed-example', icon: Eye },
  //     ]},
  //   ],
  // },
  // {
